"""
Django settings for withered_glitter_5 project.
...
ROOT_URLCONF = 'withered_glitter_5.urls'
...
WSGI_APPLICATION = 'withered_glitter_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_glitter_5 API",
    "DESCRIPTION": "API documentation for withered_glitter_5 App",
    "VERSION": "v1",
}
